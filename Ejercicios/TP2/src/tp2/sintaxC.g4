...
paramList: typeSpecifier varId paramList
         | COMMA typeSpecifier varId paramList
         |
         ;
...
expression : varId assignmentOperator expression 
           | varId PLUSPLUS 
           | varId LESSLESS 
           | simpleExpression
           ;
...
value: OPAR expression CPAR 
     | call
     | resValue
     ;

// Llamada a funcion
call: varId OPAR args CPAR;
